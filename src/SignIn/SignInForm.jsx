    ...
    return(
        <div className="bg-[url('./assets/images/signinback.svg')] relative w-screen h-screen py-4 bg-no-repeat bg-cover bg-center flex justify-center items-center">
            <div className="absolute -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 bg-white w-full h-[500px] max-w-[450px] max-h-screen px-10 py-10 flex flex-col justify-around rounded-3xl">
                ...
                <span className="font-['Poppins'] text-[#155263] text-sm flex justify-end">Recover Password</span>
                <div className="flex flex-row justify-evenly items-center">
                    <span className="font-['Poppins'] text-[#155263] text-sm">Puedes continuar con:</span>
                    <a href="#">
                ...
                <span className="flex justify-center font-['Poppins'] text-[#155263]">
                     ¿No tienes una cuenta? <span className="text-[#155263] font-bold ml-[10px] cursor-pointer" onClick={handleSignUpClick}> Registrate ahora</span>
                </span>
