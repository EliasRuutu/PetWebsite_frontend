const ClientNameCard = (props) => {
  ...
  return (
    <>
      <div
        className="client flex flex-row gap-2 justify-start m-2 rounded-2xl items-center cursor-pointer w-full hover:bg-[#EBFCFF]"
        onClick={handleClick}
      >
        <div className="avatar rounded-lg overflow-hidden">
          <img
            src={`/assets/images/clients/${props.client.avatarName}`}
            width={64}
