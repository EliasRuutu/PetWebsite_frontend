    ...
    return(
        <div className="w-full flex top-10">
            <div className="flex w-1/6 border-r-2 h-screen flex-col mt-[130px]">
                ...
                <span className="w-full flex pt-5 text-xl justify-center items-center">
                    <svg className="mr-4" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18.3476 6.09398C18.3476 9.04537 15.955 11.438 13.0036 11.438C10.0522 11.438 7.65967 9.04537 7.65967 6.09398C7.65967 3.14258 10.0522 0.75 13.0036 0.75C15.955 0.75 18.3476 3.14258 18.3476 6.09398Z" stroke="#929292" stroke-width="1.5" stroke-linecap="round"/>
                        <path d="M2.90307 17.1184C3.69323 15.6121 5.29313 14.8833 6.8924 14.8833H13.0041H19.1157C20.715 14.8833 22.3149 15.6121 23.1051 17.1184C23.928 18.6873 24.8854 21.1 25.0071 23.999C25.0354 24.6749 24.4861 25.2037 23.8405 25.2037H2.16761C1.52205 25.2037 0.97269 24.6749 1.00105 23.999C1.1227 21.1 2.08011 18.6873 2.90307 17.1184Z" stroke="#929292" stroke-width="1.5" stroke-linecap="round"/>
                    </svg>
                    <h1 className="font-['Poppins'] text-xl text-[#155263] font-bold">
                        Clientes
                    </h1>
            ...
            <div className="flex w-5/6 h-screen mt-[130px] flex-col border-t-2 mb-3 bg-[#EBFCFF] px-[250px] pt-[30px]">
                <div className="flex mb-[10px]">
                    <h1 className="font-['Poppins'] py-7 text-[#155263] text-2xl font-bold w-full">Mi perfil</h1>
                </div>
                    ...
                    <div className="flex flex-row gap-4 justify-between">
                        ...
                        <div className="flex flex-col w-1/3 gap-3">
                            <div className="flex flex-col gap-2">
                                <h1 className="text-[16px] text-[#155263] font-['Poppins']">Nombre</h1>
                                <Input className="p-2 rounded-md bg-[#F8F8F8] indent-1.5" placeholder="Alexandra" />
                            </div>
                            <div className="flex flex-col text-[#155263] gap-2">
                                <h1 className="text-[16px] text-[#155263] font-['Poppins']">Correo</h1>
                                <Input className="p-2 rounded-md bg-[#F8F8F8] indent-1.5" placeholder="alexandra@gmail.com" />
                            </div>
                            <div className="flex flex-col text-[#155263] gap-2">
                                <h1 className="text-[16px] text-[#155263] font-['Poppins']">Contraseña</h1>
                                <PasswordInput sendPasswordToParent = {setUpdatePassword} />
                            </div>
                        </div>
                        <div className="flex flex-col gap-3 w-1/3">
                            <div className="flex flex-col gap-2">
                                <h1 className="text-[16px] text-[#155263] font-['Poppins']">Apellido</h1>
                                <Input className="p-2 rounded-md bg-[#F8F8F8] indent-1.5" placeholder="Gomez" />
                            </div>
                            <div className="flex flex-col text-[#155263] gap-2">
                                <h1 className="text-[16px] text-[#155263] font-['Poppins']">Teléfono</h1>
                                <Input className="p-2 rounded-md bg-[#F8F8F8] indent-1.5" placeholder="+58 789-564-52" />
                            </div>
                            <div className="flex flex-col text-[#155263] gap-2">
                                <h1 className="text-[16px] text-[#155263] font-['Poppins']">Confirmar contraseña</h1>
                                <PasswordInput sendPasswordToParent = {setUpdatePassword} />
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        <h1 className="text-[#155263] font-['Poppins'] text-[16px]">Dirección</h1>
                        <Textarea className="border rounded-md py-2" />
                    </div>
